...
if ( ! class_exists( 'Jewellery_Lite_Content_Creation' ) ) :

	/**
	 * Jewellery_Lite_Content_Creation class.
	 */
	class Jewellery_Lite_Content_Creation extends WP_Customize_Control {
		...
		/**
		 * Jewellery_Lite_Content_Creation constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'Jewellery_Lite_Content_Creation' );
